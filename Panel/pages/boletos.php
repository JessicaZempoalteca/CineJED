...
if (!isset($_SESSION['idUsuario'])) {
  ...
  $query_text = 'SELECT boleto.idBoleto, boleto.idProyeccion, boleto.idUsuario, boleto.asiento, boleto.fecha, (boleto.precio*boleto.asiento) as total,
                        salaproyectapeliculas.idPelicula, salaproyectapeliculas.idProyeccion, salaproyectapeliculas.idSala, salaproyectapeliculas.idHorario, 
                        peliculas.idPelicula, peliculas.nombrePelicula, 
                        sala.idSala, sala.idSucursal, sala.tipoSala,
                        sucursal.idSucursal, sucursal.nombreSucursal, 
                        usuarios.idUsuario, usuarios.nombre, usuarios.ApellidoPaterno, usuarios.apellidoMaterno,
                        horarioPeliculas.horaProyeccion
                        from boleto inner join salaproyectapeliculas inner join peliculas inner join sala inner join sucursal inner join usuarios inner join horariopeliculas
                        on boleto.idProyeccion=salaproyectapeliculas.idProyeccion and boleto.idUsuario=usuarios.idUsuario 
                        and salaproyectapeliculas.idPelicula=peliculas.idPelicula and salaproyectapeliculas.idSala=sala.idSala 
                        and sala.idSucursal=sucursal.idSucursal and salaproyectapeliculas.idHorario=horariopeliculas.idHorario;';
