...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard | Nueva película</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Película nueva</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="./dashboard.php">Inicio</a></li>
                  <li class="breadcrumb-item"><a href="./peliculas_Familiares.php">Películas Familiares</a></li>
                  <li class="breadcrumb-item"><a href="./peliculas_Comedia.php">Películas Comedia</a></li>
                  <li class="breadcrumb-item"><a href="./peliculas_Accion.php">Películas Accion</a></li>
                  <li class="breadcrumb-item active">Nueva película</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
                    ...
                    <form id="form-usuario" action="../backend/crud/peliculasFamiliares/insertPeliculaFamiliar.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Protagonistas</label>
                                        <input type="text" name="protagonistas" class="form-control" id="protagonistas" placeholder="Protagonistas de la pelicula">
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="./peliculas_Familiares.php" class="btn btn-danger">Cancelar</a>
                        </div>
                    </form>
                    </div>
                    <!-- /.card -->
