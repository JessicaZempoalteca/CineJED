        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">¿Cómo podemos ayudarte?</h3>
                </div>
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="email:required">Correo electrónico obligatorio</div>
                                <div class="invalid-feedback" data-sb-feedback="email:email">Este correo electrónico no es válido</div>
                            </div>
                            <div class="form-group mb-md-0">
                                <!-- Phone number input-->
                                <input class="form-control" id="phone" type="tel" placeholder="Télefono *" data-sb-validations="required" />
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Número telefonico obligatorio</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="d-none" id="submitSuccessMessage">
                        <div class="text-center text-white mb-3">
                            <div class="fw-bolder" style="color: red;">Mensaje enviado correctamente</div>
                        </div>
                    </div>
