    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background-color: #010101;">
        <div class="container nav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <?php echo crear_menu2('pages', 'peliculas'); ?>
            </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="px-5 py-5 py-lg-0 my-5 my-lg-0 sc-bxivhb hgSmeg">
                            <ul class="font-weight-light small py-2">
                                <li class="nav-item">
                                    <a class="nav-link py-1 text-white" href="./about.php">Sobre CineJED</a>
                                </li>
                                ...
                                <li class="nav-item"><a class="nav-link py-1 text-white" href="./about.php">Bolsa de trabajo cines</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
